...
CREATE TABLE `magazzino` (
  ...
  `maxCorsia` int NOT NULL,
  `maxScaffale` int NOT NULL,
  PRIMARY KEY (`idMagazzino`),
  KEY `PuntoVenditaAssociato_idx` (`idPuntoVendita`),
  CONSTRAINT `PuntoVenditaAssociato` FOREIGN KEY (`idPuntoVendita`) REFERENCES `puntovendita` (`idPuntoVendita`)
