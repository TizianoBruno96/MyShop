...
CREATE TABLE `posizione` (
  `idPosizione` int NOT NULL AUTO_INCREMENT,
  `pCorsia` int NOT NULL,
  `pScaffale` int NOT NULL,
  `Quantita` int DEFAULT NULL,
  `idMagazzino` int NOT NULL,
  `idProdotto` int DEFAULT NULL,
  PRIMARY KEY (`idPosizione`),
  UNIQUE KEY `idPosizione_UNIQUE` (`idPosizione`),
  KEY `Magazzino_idx` (`idMagazzino`),
  KEY `OccupazioneProdotto_idx` (`idProdotto`),
  CONSTRAINT `Magazzino` FOREIGN KEY (`idMagazzino`) REFERENCES `magazzino` (`idMagazzino`),
  CONSTRAINT `OccupazioneProdotto` FOREIGN KEY (`idProdotto`) REFERENCES `prodotto` (`idProdotto`)
