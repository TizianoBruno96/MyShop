...
CREATE TABLE `servizio` (
  ...
  KEY `Fornitore_idx` (`idFornitore`),
  KEY `Categoria_idx` (`idCategoria`),
  CONSTRAINT `CategoriaServizio` FOREIGN KEY (`idCategoria`) REFERENCES `categoria` (`idCategoria`),
  CONSTRAINT `FornitoreServizio` FOREIGN KEY (`idFornitore`) REFERENCES `fornitore` (`idFornitore`)
...
-- Dump completed on 2022-08-22 11:07:02
