...
CREATE TABLE `utenteregistrato` (
  `idUtenteRegistrato` int NOT NULL,
  `idPuntoVendita` int NOT NULL,
  PRIMARY KEY (`idUtenteRegistrato`,`idPuntoVendita`),
  KEY `PuntoVendita_idx` (`idPuntoVendita`),
  CONSTRAINT `PuntoVendita` FOREIGN KEY (`idPuntoVendita`) REFERENCES `puntovendita` (`idPuntoVendita`)
